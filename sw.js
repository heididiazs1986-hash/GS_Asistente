const CACHE='gs-asistente-v2.1.0';
const ASSETS=['./','./index.html','./styles.css','./app.js','./vendor-docx.js','./manifest.json','./icon-192.png','./icon-512.png','./icon-180.png','./inmel-logo.png','./gs-logo.png','./gs-process-logo.png','./version.json'];
